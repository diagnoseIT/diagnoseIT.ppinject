...
public class AccountActionBean extends AbstractActionBean {
	...
	public Resolution signonForm() {
		this.complexityService.compute("AccountActionBean.signonForm");
		return new ForwardResolution(SIGNON);
	}

	@OperationExecutionMonitoringProbe
	public Resolution signon() {
		this.complexityService.compute("AccountActionBean.signon");
	...
	public boolean isAuthenticated() {
		this.complexityService.compute("AccountActionBean.isAuthenticated");
